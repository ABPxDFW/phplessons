...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  ...
  <table>
    <tr>
      ...
      <td><input id="firstname" name="firstname" type="text" value="<?php echo isset($first_name) ? $first_name :''; ?>"/></td></tr>
    <tr>
      <td><label for="lastname">Last Name:</label></td>
      <td><input id="lastname" name="lastname" type="text" value="<?php echo isset($last_name) ? $last_name : ''; ?>"/></td></tr>
    <tr>
      <td><label for="email">Email:</label></td>
      <td><input id="email" name="email" type="text" value="<?php echo isset($email) ? $email : ''; ?>"/></td></tr>
    <tr>
      <td><label for="phone">Phone:</label></td>
      <td><input id="phone" name="phone" type="text" value="<?php echo isset($phone) ? $phone : ''; ?>"/></td></tr>
    <tr>
      <td><label for="job">Desired Job:</label></td>
      <td><input id="job" name="job" type="text" value="<?php echo isset($job) ? $job : ''; ?>"/></td>
  </tr>
  </table>
  <p>
    <label for="resume">Paste your resume here:</label><br />
    <textarea id="resume" name="resume" rows="4" cols="40"><?php echo isset($resume) ? $resume : ''; ?></textarea><br />
